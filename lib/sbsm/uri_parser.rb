...
module SBSM
  ...
  productions = [
    ...
    p10 = Production.new(:Variables,[:Plus403200764, t2],LiftingSyntaxTreeBuilder.new(["pair"],[])),
    p11 = Production.new(:Variables,[:Plus403200764],LiftingSyntaxTreeBuilder.new(["pair"],[nil])),
    p12 = Production.new(:Plus403200764,[:Plus403200764, :Pair],ArrayNodeBuilder.new([1],0,nil,nil,[],true)),
    p13 = Production.new(:Plus403200764,[:Pair],ArrayNodeBuilder.new([0],nil,nil,nil,[],true)),
  ...
  action_table = [[5, 2], [13, 8, 32, 1], [2, 1], [17, 2, 28, 1], [21, 4, 24, 1], [25, 2, 20, 1], [29, 4, 16, 1], [33, 2, 12, 1], [41, 4, 8, 1], [53, 2, 41, 4, 40, 1], [61, 2, 64, 7], [4, 1], [48, 7], [36, 1], [44, 7], [65, 2, 69, 4], [60, 7], [73, 2, 56, 7], [52, 7]]
  goto_hash = {0 => {1 => 2}, 8 => {2 => 11, 3 => 9, 4 => 12}, 9 => {4 => 14}}
  @@parse_table403398368 = ParseTable.new(productions,tokens,priorities,action_table,goto_hash,2,[
    :REDUCE,
    :SHIFT,
    :ACCEPT
  ])
  def SBSM._uri_parser
    GeneralizedLrParser.new(@@parse_table403398368)
  end
end
